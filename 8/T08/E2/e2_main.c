...
int main() {
    ...
    test(data, "12:00", "RossiMarroneVerdiBianchiViolaAzzurra", sizeof(data) - 1);
    test(data, "20:00", "MarroneVerdiBianchiViolaAzzurra", sizeof(data) - 1);
    test(data, "20:30", "VerdiBianchiViolaAzzurra", sizeof(data) - 1);
    test(data, "21:00", "BianchiViolaAzzurra", sizeof(data) - 1);
    test(data, "21:01", "Azzurra", sizeof(data) - 1);
    test(data, "22:00", "", sizeof(data) - 1);
